...
night = dbDiel(q,lat, long,  startEffort1, endEffort1); %Make sure that you check which dates are in startEffort and endEffort, adjust to startEffort2 or endEffort1 if necessary.
