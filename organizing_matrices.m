...
OSP=OmatrixSDTDP01; %change this to whatever your matrix is and save as MSP

% step 2B: clean up MSP 
MSP=OSP(2:end,1:48); %change the last value to whatever the last column is (depending on if going up to 1000 or 5000 hz)
...
%% STEP 4: 
%now save f
f=60:20:1000 %creates the frequency range by 20 hz (change middle and end values based on what you have in matrix)
